 ...
 * @author anme05
 * 
 * HttpServlet for FileUpload widget called from Client.
 * All browsers don't support files full path. Therefore, get name and copy the content to a file and save to system known directory. 
 * Stores the file name and writes/copies the file to Directory known to Application currently "C:\\ICMWIND_DATA". TODO: Change the known UPLOAD_DIRECTORY
 *
 */
