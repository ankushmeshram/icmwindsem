...
public final class ICMWindSetup {
	...
	public static void init() {
		try {
			...
			ENCODING_PATH = icmwindconfig.getProperty("ENCODING_PATH", "! Encoding Folder not found.");
	...
	/**
	 * @return Path of folder to store encoded data files
	 */
	public static String getEncodingPath() {
