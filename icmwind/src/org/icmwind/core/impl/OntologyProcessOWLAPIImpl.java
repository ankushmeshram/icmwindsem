 ...
 * 
 */
public class OntologyProcessOWLAPIImpl implements OntologyProcess {

	private static final OntologyProcessOWLAPIImpl INSTANCE = new OntologyProcessOWLAPIImpl();
	...
	private OntologyProcessOWLAPIImpl() {
		populate();
	}
...
//		mapPropertyClassNameToSensorClassName.put(, );
	 ...
	 */
	public static OntologyProcessOWLAPIImpl getInstance() {
	...
	public boolean openFile(String filepath) {
		try {
			this.ontology = manager.loadOntology(IRI
					.create(OntologyProcessOWLAPIImpl.class.getClassLoader()
